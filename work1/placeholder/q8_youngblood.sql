...
from (select Region.Id,RegionDescription,FirstName,LastName,max(BirthDate),BirthDate from Employee inner join EmployeeTerritory on Employee.Id=EmployeeTerritory.EmployeeId
